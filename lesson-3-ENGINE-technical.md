...
> **Архітектура:** студент взаємодіє з обгорткою `outreach-architect` (інтерактивний скіл-консультант, головна роздатка Lesson 3). Вона під капотом викликає ці 4 команди. Цей SPEC = двигун; `SKILL.md` = водій. Пакуються разом у `profigent-lesson_3.zip`.
